# Description: This script contains the solution code for the Vehicle Routing Problem (VRP) using a Genetic Algorithm

# Make sure that your system has these python libraries installed
# numpy, matplotlib, deap
